    ...
    return (
      <>
        ...
        <button className="btn btn-outline-dark me-2" onClick={()=> setFilter(data)}  >Todo</button>
          <button className="btn btn-outline-dark me-2" onClick={()=> filterProduct("electronics")}  >Tegnologia</button>
      ...
      <div className="container my-5 py-5">
        <div className="row">
          <div className="col-12 mb-5">
            <h1 className="display-6 fw-bolder text-center">Categorías</h1>
            <hr />
          </div>
        </div>
